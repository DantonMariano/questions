...
<body>
  ...
  <div class="container container__main">
    <div class="row d-flex justify-content-center">
      <div class="col-8 my-5">
        <form action="/api/v1/user/login" method="POST" class="login__main__form">
          <div class="mb-3">
          ...
          <br>
          <button type="submit" class="btn btn-outline-dark login__form__button">Entrar</button>
          @csrf
          @if ($errors->any())
  ...
  <footer class="home__footer">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 240" class="home__footer__svg">
      <path fill="#f3f4f5" fill-opacity="1" d="M0,64L48,69.3C96,75,192,85,288,80C384,75,480,53,576,80C672,107,768,181,864,202.7C960,224,1056,192,1152,186.7C1248,181,1344,203,1392,213.3L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
    </svg>
  </footer>
</body>
